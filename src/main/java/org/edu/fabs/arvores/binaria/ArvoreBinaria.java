...
public class ArvoreBinaria<T extends Comparable<T>> {
    ...
    private BinNo<T> inserir(BinNo<T> atual, BinNo<T> novoNo) {
        ...
        if (atual == null) { // significa q esta vazia, pego valor do atual e seto como a raiz
            ...
            atual.setNoDir(inserir(atual.getNoDir(), novoNo)); // RECURSIVIDADE
        }
        return atual;
    }
    ...
    private void exibirInOrdem(BinNo<T> atual) { // metodo privado para exibicao recursiva
        if (atual != null) {
            ...
            System.out.print(atual.getConteudo() + ", "); // exibe
    ...
    public void exibirPosOrdem() {
        System.out.print("\n Exibindo PósOrdem ");
        exibirPosOrdem(this.raiz); // metodo recursivo
    }
    ...
    public void exibirPreOrdem() {
        System.out.print("\n Exibindo PreOrdem ");
        exibirPreOrdem(this.raiz); // metodo recursivo
    }
